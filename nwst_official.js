...
window.setTimeout(function(){document.getElementById("routelist2").children[2].childNodes[1].childNodes[0].click()},1000);
window.setTimeout(function(){hidespecialNote();select()},2000);
